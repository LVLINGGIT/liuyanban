window.onload=function () {
  ...
  var oUser = document.getElementById('user');//用户界面
	var oReg = document.getElementById('reg');//注册
	var oLogin = document.getElementById('login');//登陆
	var oUserInfo = document.getElementById('userinfo');//用户界面中的用户名
  ...
  */
  ...
  oPostBtn.onclick = function() {
    ...
    ajax('post', 'guestbook/index.php', 'm=index&a=send&content='+encodeURI(oContent.value), function(data) {
      ...
      var d = JSON.parse(data);
      alert(d.message);
//"data":{"cid":3,"uid":"3","username":"momo","content":"12345","dateline":1508059997,"support":0,"oppose":0}
      if (!d.code) {
        //添加当前留言到列表中
